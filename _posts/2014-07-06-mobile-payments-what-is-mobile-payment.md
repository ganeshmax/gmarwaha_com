...
- [Tap & Pay]({{ site.baseurl }}/2014/05/11/mobile-payments-what-is-tap-pay.html) using your Mobile NFC device – Google Wallet, Isis
...
- Simulate [Magnetic Stripe]({{ site.baseurl }}/2014/04/10/mobile-payments-what-is-a-magnetic-stripe-card.html) signals – LoopPay
